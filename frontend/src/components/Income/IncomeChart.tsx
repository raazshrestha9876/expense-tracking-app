...
const incomeData = [
  { day: "Mon", income: 800, date: "Dec 2" },
  { day: "Tue", income: 950, date: "Dec 3" },
  { day: "Wed", income: 700, date: "Dec 4" },
  { day: "Thu", income: 1200, date: "Dec 5" },
  { day: "Fri", income: 1100, date: "Dec 6" },
  { day: "Sat", income: 900, date: "Dec 7" },
  { day: "Sun", income: 750, date: "Dec 8" },
]
...
const IncomeChart = () => {
  ...
  const minincome = Math.min(...incomeData.map((item) => item.income))

  // Calculate trend (comparing last 3 days vs first 3 days)
  const firstHalf = incomeData.slice(0, 3).reduce((sum, item) => sum + item.income, 0) / 3
  const secondHalf = incomeData.slice(-3).reduce((sum, item) => sum + item.income, 0) / 3
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <CardTitle className="text-2xl font-bold text-gray-900">Daily incomes</CardTitle>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <p className="text-xl font-bold text-gray-900">${averageincome.toLocaleString()}</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <p className="text-xl font-bold text-gray-900">${maxincome.toLocaleString()}</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <p className="text-xl font-bold text-gray-900">${minincome.toLocaleString()}</p>
          </div>
        </div>
      </CardHeader>
        ...
        >
          ...
          >
            ...
            <ChartTooltip
              ...
              content={
                <ChartTooltipContent
                  formatter={(value, name, props) => [`$${value.toLocaleString()}`, "income"]}
